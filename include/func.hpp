...
template<typename ValueType_>
get_value_func_t<ValueType_>
get_value(std::string_view object_name,
...
get_value_func_t<Target_>
lexical_cast(get_value_func_t<Source_>&& func)
{
...
template<typename ValueType_>
get_value_func_t<ValueType_>
add(get_value_func_t<ValueType_>&& left, get_value_func_t<ValueType_>&& right)
{
...
template<typename ValueType_>
get_value_func_t<ValueType_>
sub(get_value_func_t<ValueType_>&& left, get_value_func_t<ValueType_>&& right)
{
  return [left = std::move(left), right = std::move(right)](Context* context) {
    return left(context) - right(context);
  };
...
template<typename ValueType_>
get_value_func_t<ValueType_>
make_value(ValueType_ value)
{
  return [value](Context* context) { return value; };
}

template<typename ValueType_>
set_value_func_t
set_value(std::string_view name, get_value_func_t<ValueType_>&& func)
{
